      ...
      >
        <div className="container mx-auto px-4 h-full relative">
          <div className="flex flex-col lg:flex-row justify-between items-start h-full py-8 lg:py-20">
            ...
            <div className="flex flex-col items-center lg:items-start mt-6 lg:mt-0 w-full lg:w-auto">
              <div className="text-center lg:text-left mb-6 lg:mb-8 max-w-[334px]">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 lg:gap-3 w-[230px] lg:w-[253px] h-[45px] lg:h-[50px] px-[12px] lg:px-[15px] py-[14px] lg:py-[17px] rounded-[60px] bg-[#72B5FF] shadow-[9px_13px_4px_0px_rgba(0,0,0,0.06)] hover:bg-[#5da3ff] transition-colors"
              >
                <Phone
                  size={18}
            ...
            <div className="flex flex-col space-y-6 lg:space-y-8 mt-6 lg:mt-0 lg:mr-[120px] w-full lg:w-[192px]">
