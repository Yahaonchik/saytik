  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center justify-center gap-3 w-[253px] h-[50px] px-[38px] py-[15px] rounded-[60px] bg-transparent border-2 border-[#72B5FF] shadow-[9px_13px_4px_0px_rgba(0,0,0,0.06)]"
      >
        <svg
          width="20"
          height="19"
