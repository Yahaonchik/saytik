...
const faqData = [
  ...
  {
    question: "Выезжаете л�� вы в выходные дни?",
    answer:
      "Да, мы работаем без выходных с 9:00 до 21:00. Аварийный выезд возможен и в более позднее время по предварительному согласованию с доплатой за срочность.",
  },
  {
