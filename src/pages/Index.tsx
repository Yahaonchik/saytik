  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="relative z-50 w-full">
        <div
          className="w-full h-[60px] sm:h-[70px] md:h-[84px] bg-white/95 md:bg-white/63 shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] relative"
          style={{
        ...
        >
          <div className="w-full px-3 sm:px-4 h-full flex items-center justify-between max-w-[1989px] mx-auto">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
              <div className="w-[35px] h-[34px] sm:w-[40px] sm:h-[39px] md:w-[47px] md:h-[46px] bg-[#72B5FF] flex-shrink-0 rounded-md"></div>
              <div className="font-ibm-plex-serif text-[14px] sm:text-[16px] md:text-[24px] font-medium md:font-normal leading-tight text-[#1a1a1a] md:bg-gradient-to-r md:from-[#7F90A6] md:to-[#C2B4FC] md:bg-clip-text md:text-transparent whitespace-nowrap">
                Ремонт машинок
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              {/* Mobile menu button */}
              <button className="flex items-center justify-center w-[40px] h-[40px] rounded-[10px] border border-[rgba(0,0,0,0.18)] bg-white shadow-sm">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
      ...
      <section className="relative h-[500px] md:h-[650px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <div className="mb-12 md:mb-16">
            <h1 className="text-[24px] sm:text-[28px] md:text-[38px] font-pt-serif-caption font-normal tracking-[1.0px] md:tracking-[1.52px] mb-6 md:mb-10 max-w-[803px] leading-tight">
              <span
                className="text-[#000000] md:text-[#40444F] block font-bold md:font-normal"
                style={{ textShadow: "1px 1px 2px rgba(255,255,255,0.8)" }}
              >
                Ремонт cтиральных машин
              </span>
              <span
                className="text-[#1e40af] md:text-[#72B5FF] block font-bold md:font-normal"
                style={{ textShadow: "1px 1px 2px rgba(255,255,255,0.8)" }}
              >
                Одесса
              </span>
            ...
            <p className="text-[15px] sm:text-[16px] md:text-[15px] font-pt-serif font-normal tracking-[0.75px] max-w-[600px] mx-auto px-4 mb-6">
              <span
                className="text-[#000000] md:text-[#40444F] font-semibold md:font-normal"
                style={{ textShadow: "1px 1px 2px rgba(255,255,255,0.8)" }}
              >
                Проффессиональный ремонт стиральных машин в тот же{" "}
              </span>
              <span
                className="text-[#1e40af] md:text-[#72B5FF] font-semibold md:font-normal"
                style={{ textShadow: "1px 1px 2px rgba(255,255,255,0.8)" }}
              >
                день!
              </span>
            ...
            {/* Mobile Navigation and Info */}
            <div className="xl:hidden px-4 space-y-4">
              <div className="flex justify-center gap-3 flex-wrap">
                <a
                  href="/"
                  className="text-[#1a1a1a] bg-white/90 px-3 py-1.5 rounded-full text-[13px] font-medium border border-gray-300 shadow-sm"
                >
                  Главная
                </a>
                <a
              ...
              <div className="flex justify-center items-center gap-4 text-[13px]">
                <div className="text-[#1a1a1a] bg-white/90 px-3 py-1.5 rounded-full font-medium border border-gray-300 shadow-sm">
                  Пн-Вс: 9:00-21:00
                </div>
                <a
                  href="tel:+380671234567"
                  className="text-[#1a1a1a] bg-white/90 px-3 py-1.5 rounded-full font-medium border border-gray-300 shadow-sm"
                >
                  +38 (067) 123-45-67
                </a>
              </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 mb-16 md:mb-20 w-full">
            {/* Washing Machine Loader with mobile Quick Actions - Left side on desktop */}
            <div className="order-2 lg:order-1 flex flex-col md:flex-row items-center gap-4 md:gap-8">
              <div className="loader flex-shrink-0"></div>

              {/* Quick Actions on mobile - right of washing machine */}
              <div className="flex flex-col gap-3 md:hidden">
                <div className="flex items-center gap-2 text-[rgba(76,76,76,0.9)] font-pt-serif text-[11px] italic tracking-[5%] whitespace-nowrap">
                  <img
                    src="https://cdn.builder.io/api/v1/assets/485f32eaccd940459f228ddc7002fb07/image-3822595-dfa1a4?format=webp&width=800"
                    alt="Быстро"
                    width="16"
                    height="20"
                    className="w-[16px] h-[20px] object-contain flex-shrink-0"
                  />
                  Быстро
                </div>
                <div className="flex items-center gap-2 text-[rgba(76,76,76,0.9)] font-pt-serif text-[11px] italic tracking-[5%] whitespace-nowrap">
                  <img
                    ...
                    width="24"
                    height="20"
                    className="w-[24px] h-[20px] object-contain flex-shrink-0"
                  />
                  Качественно
                </div>
                <div className="flex items-center gap-2 text-[rgba(76,76,76,0.9)] font-pt-serif text-[11px] italic tracking-[5%] whitespace-nowrap">
                  <img
                    ...
                    width="18"
                    height="19"
                    className="w-[18px] h-[19px] object-contain flex-shrink-0"
                  />
                  С гарантией
                </div>
              </div>
            ...
            <div className="flex flex-col gap-4 w-full max-w-[253px] order-1 lg:order-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-3 w-full h-[45px] md:h-[50px] px-[20px] md:px-[38px] py-[15px] rounded-[60px] bg-white shadow-[8px_12px_4px_0px_rgba(0,0,0,0.09)]"
              >
                <svg
                  width="20"
                  height="20"
