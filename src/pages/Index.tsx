        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-evenly items-center text-center lg:justify-center">
          ...
          <div className="flex flex-col gap-3 w-full max-w-[253px] order-1 lg:order-2 mb-6 lg:mb-0 lg:hidden">
            <button
              ...
              className="flex items-center justify-center gap-3 w-full h-[38px] md:h-[50px] px-[16px] md:px-[38px] py-[12px] md:py-[15px] rounded-[60px] bg-transparent border-2 border-[#72B5FF] shadow-[9px_13px_4px_0px_rgba(0,0,0,0.06)]"
            >
              <svg
                width="16"
                height="15"
